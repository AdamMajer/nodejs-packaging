...
s/{{bundled_nghttp2_version}}/1.64.0/g
s/{{bundled_ngtcp2_version}}/1.9.1/g
s/{{bundled_openssl_version}}/3.0.15/g
s/{{bundled_uv_version}}/1.49.2/g
s/{{bundled_uvwasi_version}}/0.0.21/g
s/{{bundled_v8_version}}/12.4.254.21/g
s/{{bundled_npm_version}}/10.9.2/g
s/{{bundled_simdutf_version}}/5.6.4/g
s/{{bundled_ada_version}}/2.9.2/g
s/{{bundled_simdjson_version}}/3.10.1/g
